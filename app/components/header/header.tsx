...
const Header = () => {
    return (
        <div className="fixed z-50 w-full sm:left-0 sm:right-0 sm:top-6 sm:max-w-fit sm:mx-auto flex sm:rounded-full backdrop-blur-lg header-blur" style={{ backgroundColor: "rgba(18,18,18, 0.2)" }}>
