...
const VisitGithub = () => {
    return (
        <Link href="https://github.com/IsmailYaman" target="_blank">
            <div className="card hover:shadowxl hover:shadow-primary/50 group w-full h-full bg-base-100 hover:scale-105 mx-auto ease-out duration-100 cursor-pointer">
